...
class RadialPostCent extends Page {
	...
	function __construct($seg, $proc, $ver, $sec, $step) {
		...
		parent::__construct("../templates/radial_post_cent_template.html");
	}
...
new RadialPostCent($_GET['seg'], $_GET['proc'], $_GET['ver'], $_GET['sec'], $_GET['step']);
