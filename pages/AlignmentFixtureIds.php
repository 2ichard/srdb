...
class AlignmentFixtureIds extends Page {
	...
	function __construct($seg, $proc, $ver, $sec, $step) {
		...
		parent::__construct("../templates/alignment_fixture_ids_template.html");
	}
...
new AlignmentFixtureIds($_GET['seg'], $_GET['proc'], $_GET['ver'], $_GET['sec'], $_GET['step']);
