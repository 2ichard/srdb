...
class FlexRodRunout extends Page {
	...
	function __construct($seg, $proc, $ver, $sec, $step) {
		...
		parent::__construct("../templates/flex_rod_runout_template.html");
	}
...
new FlexRodRunout($_GET['seg'], $_GET['proc'], $_GET['ver'], $_GET['sec'], $_GET['step']);
