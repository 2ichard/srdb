...
class AxialHoleMeas extends Page {
	...
	function __construct($seg, $proc, $ver, $sec, $step) {
		...
		$this->sec = $sec;
		$this->step = $step;
		parent::__construct("../templates/axial_hole_meas_template.html");
	}
...
new AxialHoleMeas($_GET['seg'], $_GET['proc'], $_GET['ver'], $_GET['sec'], $_GET['step']);
